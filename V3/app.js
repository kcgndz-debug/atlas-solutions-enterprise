...
$("addProject").addEventListener("click",projectDialog);$("addEstimate").addEventListener("click",estimateDialog);$("addFieldReport").addEventListener("click",fieldReportDialog);$("addScheduleItem").addEventListener("click",scheduleDialog);$("addCrew").addEventListener("click",crewDialog);$("addMaterial").addEventListener("click",materialDialog);$("inviteUser").addEventListener("click",inviteUserDialog);
